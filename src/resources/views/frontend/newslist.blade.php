...
<div class="pd--80-0-20">
    <div class="container">
            ...
            <div class="col-md-12">
                <div class="top-title">
                    <div class="sec-title">
                        ...
                        <div class="h3">รายการข่าวประชาสัมพันธ์</div>
                    </div>
                    <div>
                        <form class="header--search navbar-form" action="{{ route('newslist') }}" method="GET">
                           <div style="display: flex;">
                                <input type="search" name="search" placeholder="ค้นหาเพิ่มเติม..." class="form-control m-0" value="{{ $data['search'] ?? '' }}" style="margin: 0 1px;">
                                <input type="number" name="year" placeholder="ค้นหาตาม พศ. ปีข่าว" class="form-control m-0" value="{{ $data['year'] ?? '' }}" style="margin: 0 1px;">
                           </div>
        ...
        <div class="row">
            ...
            @endforeach
            <div class="col-md-12">
                <div style="float: inline-end;">{!! $data['Query_news']->links() !!}</div>
            </div>
            @else
