...
<!-- <div class="pu-popupcontrols">
        <span id="pu-popupclose">
            <span>x</span>
        </span>
    </div>
    <div class="owl-carousel owl-popups">
        @foreach($data['Query_popups'] as $row)
        <div class="pu-box-text">
            <a href="{{ (!empty($row->link))? $row->link : '#' }}" target="_blank">
                <div class="pu-popupcontent" style="background-image: url(<?php echo asset('images/popups') . '/' . $row->image_desktop; ?>);"> </div>
                @if(!empty($row->title))
                <h5 class="m-0">{{ $row->title }}</h5>
                @endif
                @if(!empty($row->description))
                ...
                <div class="row mt-2">
                    <div class="col-md-12">
                        <div class="owl-carousel owl-theme owl-activity">
                            ...
                            <div class="item">
                                <div class="post--item owl-activity-css">
                                    <div class="owl-activity-img" style="background-image: url(<?php echo asset('images/activity/') . '/' . $row->activity_image_desktop; ?>);"> </div>
                                    <div>
                                        <div class="meta" style="margin-bottom: 5px;">
                                            <ul>
                                                <li style="font-size: 12px;"><i class="fa fa-calendar"></i> {{ date("M d", strtotime($row->activity_date)).', '.date("Y", strtotime($row->activity_date)) }}</li>
                                                <li style="font-size: 12px;"><i class="fa fa-eye"></i> {{ number_format($row->count_view) }} </li>
                                            </ul>
                                        </div>
                                        <div class="title" style="margin-bottom: 5px;">
                                            <h4 class="h4 white-space-1 m-0">{{ $row->activity_title }}</h4>
                                        </div>
                                        <p class="white-space-2"> {{ $row->activity_intro }} </p>
                                        <div class="footer">
                                            <a href="{{ route('activity', [$row->id]) }}" class="btn btn-default" style="width: 100%;">อ่านเพิ่มเติม</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!-- ******TITLEDETAIL****** -->
<div class="pd--80-0" data-bg-parallax="{{ $data['bg_detail'] }}">
    <div class="container">
                    ...
                    <div class="col-md-12">
                        <div class="row mb-2">
                            ...
                            <div class="col-xs-8 col-md-9 d-flex-column">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <span><i class="fa fa-calendar"></i> {{ date("M d", strtotime($row->news_date)).', '.date("Y", strtotime($row->news_date)) }} </span>
                                        <span><i class="fa fa-eye"></i> {{ number_format($row->count_view) }}</span>
                                    </div>
                                    <div class="col-md-6 text-right">
                                        <a href="{{ route('news', [$row->id]) }}" class="btn btn-default">อ่านเพิ่มเติม</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="container">
        <div class="row" style="display: flex; justify-content: center;">
            ...
            <!-- <div class="col-md-3 col-xs-6 col-xxs-12">
                <a href="{{ url('page/17') }}" style="color: #FFF;">
                    <div class="counter--item">
                        <div class="icon">
                        ...
                        <div class="title">
                            <h2 class="h4"> ประเมินผู้บริหาร </h2>
                        </div>
                    </div>
                </a>
            </div> -->
