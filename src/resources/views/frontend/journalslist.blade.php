...
<div class="pd--80-0-20">
    <div class="container">
            ...
            <div class="col-md-12">
                <div class="top-title">
                    <div class="sec-title">
                        ...
                        <div class="h3">รายการจดหมายข่าว</div>
                    </div>
                    <div>
                        <form class="header--search navbar-form" action="{{ route('journalslist') }}" method="GET">
                            <div style="display: flex;">
                                <input type="search" name="search" placeholder="ค้นหาเพิ่มเติม..." class="form-control m-0" value="{{ $data['search'] ?? '' }}" style="margin: 0 1px;">
                                <input type="month" name="month" placeholder="ค้นหาตาม ปีเดือนวารสาร" class="form-control m-0" value="{{ $data['month'] ?? '' }}" style="margin: 0 1px;">
                            </div>
        ...
        <div class="row">
            ...
            @endforeach
            <div class="col-md-12">
                <div style="float: inline-end;">{!! $data['Query_journals']->links() !!} </div>
            </div>
            @else
