...
<div class="page-header--section pd--80-0 text-center bg--overlay" data-bg-img="{{ asset('images/bg_detail.jpg') }}">
    <div class="container">
        <h2 class="h2">พระนารายณ์ศึกษา</h2>
        <ul class="breadcrumb">
            <li><a href="#">หน้าหลัก</a></li>
            <li><span>พระนารายณ์ศึกษา</span></li>
        </ul>
    </div>
</div>
...
<div class="pd--80-0-20">
    <div class="container"> 
            ...
            <div class="col-md-12">
                <div class="top-title">
                    <div class="sec-title">
                        ...
                        <div class="h3">รายการพระนารายณ์ศึกษา</div>
                    </div>
                    <div>   
                        <form class="header--search navbar-form" action="{{ route('studylist') }}" method="GET">
                           <div style="display: flex;">
                                <input type="search" name="search" placeholder="ค้นหาเพิ่มเติม..." class="form-control m-0" value="{{ $data['search'] ?? '' }}" style="margin: 0 1px;">
                                <input type="number" name="year" placeholder="ค้นหาปีพระนารายณ์ศึกษา พศ." class="form-control m-0" value="{{ $data['year'] ?? '' }}" style="margin: 0 1px;">
                           </div>
        ...
        <div class="row"> 
            ...
            @endforeach
             <div class="col-md-12">
                <div style="float: inline-end;">{!! $data['Query_study']->links() !!}</div>
            </div>
            @else
