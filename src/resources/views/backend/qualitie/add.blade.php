      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header" style="background: #ddd;">
            <div class="row">
              <div class="col-md-12">
                <h5 class="m-0"> เพิ่มงานประกันคุณภาพ
                ...
                <div class="col-md-8">
                  <div class="row">
                    ...
                    <div class="col-md-3 form-group">
                      ...
                      <input id="month" type="month" class="form-control form-control-lg @error('month') invalid @enderror" name="month" value="{{ old('month') }}" required autocomplete="month" autofocus placeholder="โปรดระบุข้อมูล...">
                      @error('month')
                      <ul class="parsley-errors-list filled">
                        <li class="parsley-required">{{ $message }}</li>
                      </ul>
                    ...
                    <div class="col-md-12 form-group">
                      ...
                      <textarea class="form-control form-control-lg @error('intro') invalid @enderror" rows="2" id="intro" name="intro" autocomplete="intro" autofocus placeholder="โปรดระบุข้อมูล..." required>{{ old('intro') }}</textarea>
                      @error('intro')
                      <ul class="parsley-errors-list filled">
                        <li class="parsley-required">{{ $message }}</li>
                      </ul>
