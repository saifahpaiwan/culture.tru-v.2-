          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header" style="background: #ddd;">  
                <div class="row">   
                  <div class="col-md-12"> 
                    <h5 class="m-0"> แก้ไขเว็บไซต์ที่เกี่ยวข้อง 
              ...
              <div class="card-body">  
                ...
                <form method="POST" action="{{ route('save.relatedsites') }}" id="form" enctype="multipart/form-data">
                  ...
                  <input type="hidden" id="id" name="id" value="{{ $data['relatedsites_find']->id }}">
                  ...
                  <div class="row"> 
                    <div class="col-md-10 form-group"> 
                      ...
                      value="{{ $data['relatedsites_find']->title }}"
                    ...
                    <div class="col-md-12 form-group"> 
                      ...
                      value="{{ $data['relatedsites_find']->slug }}"
                    ...
                    <div class="col-md-12 form-group"> 
                      ...
                      <div class="cc-selector">  
                        <div class="cc-selector"> 
                        <input id="status1" type="radio" name="status" value="0" {{ $data['relatedsites_find']->deleted_at == true ? $data['relatedsites_find']->deleted_at == 0 ? "checked" : ""  : "checked"  }}/>
                        <label class="drinkcard-cc bg-success" for="status1"> เปิดการแสดงผล </label>  

                        <input id="status2" type="radio" name="status" value="1" {{ $data['relatedsites_find']->deleted_at == 1 ? "checked" : "" }}/>
                    ...
                    <div class="col-md-6 form-group"> 
                      ...
                      <div class="img-file-upload-2"> 
                        <img src="{{ asset('images/relatedsites').'/'.$data['relatedsites_find']->image_desktop }}" class="event-icon" style="width: 200px; height: 80px; border: 1px solid #ddd;"> 
                      </div>
                      ...
                      <input type="hidden" id="file_upload_dektop_hdf" name="file_upload_dektop_hdf" value="{{ $data['relatedsites_find']->image_desktop }}">
                  ...
                  <div class="row"> 
                    <div class="col-md-12 form-group text-right">   
                      ...
                      <button type="button" class="btn btn-lg btn-danger waves-effect waves-light" id="close" data-id="{{ $data['relatedsites_find']->id }}"> 
    ...
    Swal.fire({
        ...
        if (result.value) {  
          ...
          .done(function(data, status, error){   
            if(error.status==200){     
              location.href = "{{ route('relatedsites.list') }}";
            }
          })
