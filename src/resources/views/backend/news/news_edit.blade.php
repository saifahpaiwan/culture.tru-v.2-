            ...
            <form method="POST" action="{{ route('save.news') }}" id="form" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-8">
                  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input id="news_title" type="text" class="form-control form-control-lg @error('news_title') invalid @enderror" name="news_title" value="{{ $data['news_find']->news_title }}" required autocomplete="news_title" autofocus placeholder="โปรดระบุข้อมูล...">
                      @error('news_title')
                    ...
                    <div class="col-md-12 form-group">
                      ...
                      <input id="news_meta_title" type="text" class="form-control form-control-lg @error('news_meta_title') invalid @enderror" name="news_meta_title" value="{{ $data['news_find']->news_meta_title }}" autocomplete="news_meta_title" autofocus placeholder="โปรดระบุข้อมูล...">
                    ...
                    <div class="col-md-12 form-group">
                      ...
                      <input id="news_meta_description" type="text" class="form-control form-control-lg @error('news_meta_description') invalid @enderror" name="news_meta_description" value="{{ $data['news_find']->news_meta_description }}" autocomplete="news_meta_description" autofocus placeholder="โปรดระบุข้อมูล...">
                    ...
                    <div class="col-md-12 form-group">
                      ...
                      <input id="news_meta_keyword" type="text" class="form-control form-control-lg @error('news_meta_keyword') invalid @enderror" name="news_meta_keyword" value="{{ $data['news_find']->news_meta_keyword }}" autocomplete="news_meta_keyword" autofocus placeholder="โปรดระบุข้อมูล...">
                  ...
                  <div class="col-md-12 form-group">
                    <div class="mb-1">
                      ...
                      <div class="img-file-upload-2">
                        <img src="{{ asset('images/news').'/'.$data['news_find']->news_image_desktop }}" class="rounded w-100">
                      </div>
                ...
                <div class="col-md-12">
                  ...
                  <textarea cols="10" id="news_file_text" name="news_file_text" rows="10"><?php echo @file_get_contents(storage_path() . '/app/' . $data['news_find']->news_file_text); ?></textarea>
              ...
              <div class="row">
                ...
                <div class="col-md-6 form-group text-right">
                  <a href="{{ route('news.dropzone', $data['news_find']->id) }}" class="btn btn-lg btn-secondary waves-effect waves-light">
                    <i class="fe-image"></i>
