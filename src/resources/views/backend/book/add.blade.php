            ...
            <form method="POST" action="{{ route('save.book') }}" id="form" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-8">
                  <div class="row">
                    <div class="col-md-5 form-group">
                      ...
                      <input id="title" type="text" class="form-control form-control-lg @error('title') invalid @enderror" name="title" value="{{ old('title') }}" required autocomplete="title" autofocus placeholder="โปรดระบุข้อมูล...">
                      @error('title')
                    ...
                    <div class="col-md-5 form-group">
                      ...
                      <input id="author" type="text" class="form-control form-control-lg @error('author') invalid @enderror" name="author" value="{{ old('author') }}" required autocomplete="author" autofocus placeholder="โปรดระบุข้อมูล...">
                      @error('author')
                      <ul class="parsley-errors-list filled">
                        <li class="parsley-required">{{ $message }}</li>
                      </ul>
                    ...
                    <div class="col-md-2 form-group">
                      ...
                      <select class="form-control form-control-lg @error('type') invalid @enderror" name="type" id="type">
                        ...
                        <option value="วารสารสำนักงาน"> วารสารสำนักงาน </option>
                      </select>
                      @error('type')
                      <ul class="parsley-errors-list filled">
                        <li class="parsley-required">{{ $message }}</li>
                    ...
                    <div class="col-md-10 form-group">
                      ...
                      <input id="keyword" type="text" class="form-control form-control-lg @error('keyword') invalid @enderror" name="keyword" value="{{ old('keyword') }}" required autocomplete="keyword" autofocus placeholder="โปรดระบุข้อมูล...">
                      @error('keyword')
                      <ul class="parsley-errors-list filled">
                        <li class="parsley-required">{{ $message }}</li>
                      </ul>
                    ...
                    <div class="col-md-2 form-group">
                      ...
                      <input id="year" type="number" class="form-control form-control-lg @error('year') invalid @enderror" name="year" value="{{ old('year') }}" required autocomplete="year" autofocus placeholder="โปรดระบุข้อมูล...">
                      @error('year')
                      <ul class="parsley-errors-list filled">
                        <li class="parsley-required">{{ $message }}</li>
                      </ul>
                    ...
                    <div class="col-md-12 form-group">
                      ...
                      <input id="published" type="text" class="form-control form-control-lg @error('published') invalid @enderror" name="published" value="{{ old('published') }}" required autocomplete="published" autofocus placeholder="โปรดระบุข้อมูล...">
                      @error('published')
                      <ul class="parsley-errors-list filled">
                        <li class="parsley-required">{{ $message }}</li>
                      </ul>
                    ...
                    <div class="col-md-12 form-group">
                      ...
                      <textarea class="form-control form-control-lg @error('intro') invalid @enderror" rows="2" id="intro" name="intro" autocomplete="intro" autofocus placeholder="โปรดระบุข้อมูล...">{{ old('intro') }}</textarea>
                      @error('intro')
                      <ul class="parsley-errors-list filled">
                        <li class="parsley-required">{{ $message }}</li>
                      </ul>
                    ...
                    <div class="col-md-12 form-group">
                      ...
                      <input id="meta_title" type="text" class="form-control form-control-lg @error('meta_title') invalid @enderror" name="meta_title" value="{{ old('meta_title') }}" autocomplete="meta_title" autofocus placeholder="โปรดระบุข้อมูล...">
                      @error('meta_title')
                      <ul class="parsley-errors-list filled">
                        <li class="parsley-required">{{ $message }}</li>
                      </ul>
                    ...
                    <div class="col-md-12 form-group">
                      ...
                      <input id="meta_description" type="text" class="form-control form-control-lg @error('meta_description') invalid @enderror" name="meta_description" value="{{ old('meta_description') }}" autocomplete="meta_description" autofocus placeholder="โปรดระบุข้อมูล...">
                    ...
                    <div class="col-md-12 form-group">
                      ...
                      <input id="meta_keyword" type="text" class="form-control form-control-lg @error('meta_keyword') invalid @enderror" name="meta_keyword" value="{{ old('meta_keyword') }}" autocomplete="meta_keyword" autofocus placeholder="โปรดระบุข้อมูล...">
                      @error('meta_keyword')
                      <ul class="parsley-errors-list filled">
                        <li class="parsley-required">{{ $message }}</li>
                      </ul>
                ...
                <div class="col-md-12">
                  ...
                  <textarea cols="10" id="file_text" name="file_text" rows="10"><?php echo old('file_text'); ?></textarea>
                  @error('file_text')
                  <span class="invalid-feedback" role="alert">
                    <strong><i class="fa fa-times-circle" aria-hidden="true"></i> {{ $message }}</strong>
                  </span>
