    ...
    <div class="row">
      <div class="col-12">
        <div class="page-title-box">
          <h4 class="page-title"> <i class="fa fa-book"></i> แก้ไขวิดีโอผลงานผ่านเลนส์ </h4>
        </div>
      </div>
    </div>
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header" style="background: #ddd;">
            <div class="row">
              <div class="col-md-12">
                <h5 class="m-0">  แก้ไขวิดีโอผลงานผ่านเลนส์  </h5>
              </div>
            </div>
          </div>
          <div class="card-body">
            ...
            @endif
            <form method="POST" action="{{ route('youtube.save') }}" id="form" enctype="multipart/form-data">
              @csrf
              <input type="hidden" id="statusData" name="statusData" value="U">
              <input type="hidden" id="id" name="id" value="{{ $data['videoYoutube']->id ?? 0 }}">
                  ...
                  <div class="col-md-12 form-group">
                    <div class="mb-2">
                      ...
                      <div class="cc-selector">
                        <input id="status1" type="radio" name="status" value="0" {{  $data['videoYoutube']->deleted_at == true ?  $data['videoYoutube']->deleted_at == 0 ? "checked" : ""  : "checked"  }} />
                        <label class="drinkcard-cc bg-success" for="status1"> เปิดการแสดงผล </label>

                        <input id="status2" type="radio" name="status" value="1" {{  $data['videoYoutube']->deleted_at == 1 ? "checked" : "" }} />
