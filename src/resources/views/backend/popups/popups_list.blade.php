              ...
              <div class="card-header" style="background: #ddd;">  
                <div class="row">  
                  ...
                  <div class="col-md-3 text-right"> 
                    ...
                    <a href="{{ route('popups.add') }}" class="btn btn-primary waves-effect waves-light"><i class="fe-plus-square"></i> เพิ่ม </a> 
                  </div>
                </div>
              </div>
              <div class="card-body">  
                ...
                <div class="table-responsive"> 
                  <table class="table table-borderless nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;" id="tbl-data">
                    <thead>
                      <tr>   
                        <th width="5%"> รูป Pop Up </th>    
                        <th> ชื่อรูป Pop Up </th> 
...
$(document).on('click', '#search', function(event) { 
  ...
  function datatable(keywrod, status){  
    var table = $('#tbl-data').DataTable({
      ...
      columns: [   
        {data: 'popups_img', name: 'popups_img'},  
        {data: 'title', name: 'title'},
        {data: 'popups_status', name: 'popups_status'}, 
