            ...
            <form method="POST" action="{{ route('save.learning') }}" id="form" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-8">
                  <div class="row">
                    <div class="col-md-9 form-group">
                      <label class="ml-1" for="title"> ชื่อแหล่งเรียนรู้ <span class="text-danger">*</span></label>
                      <input id="title" type="text" class="form-control form-control-lg @error('title') invalid @enderror" name="title" value="{{ $data['learning_find']->title }}" required autocomplete="title" autofocus placeholder="โปรดระบุข้อมูล...">
                      @error('title')
                    ...
                    <div class="col-md-3 form-group">
                      <label class="ml-1" for="type"> ประเภท <span class="text-danger">*</span>
                        <a href="{{ route('learningtype.list') }}"><i class="fa fa-plus-circle"></i> <small>เพิ่มประเภท</small> </a>
                      </label>
                      <select class="form-control form-control-lg @error('type') invalid @enderror" name="type" id="type">
                        <option value=""> เลือกประเภท </option>
                        @if(isset($data['learning_types']) && count($data['learning_types'])>0)
                        @foreach($data['learning_types'] as $row)
                        <option {{ ($data['learning_find']->type==$row->id)? "selected" : "" }} value="{{ $row->id }}"> {{ $row->name }} </option>
                        @endforeach
                        @endif
                      </select>
                      @error('type')
                    ...
                    <div class="col-md-9 form-group">
                      <label class="ml-1" for="keyword"> สถานที่ตั้ง <span class="text-danger">*</span></label>
                      <input id="keyword" type="text" class="form-control form-control-lg @error('keyword') invalid @enderror" name="keyword" value="{{ $data['learning_find']->keyword }}" required autocomplete="keyword" autofocus placeholder="โปรดระบุข้อมูล...">
                      @error('keyword')
                      <ul class="parsley-errors-list filled">
                        <li class="parsley-required">{{ $message }}</li>
                      </ul>
                    ...
                    <div class="col-md-3 form-group">
                      <label class="ml-1" for="year"> ปีที่ <span class="text-danger">*</span></label>
                      <input id="year" type="number" class="form-control form-control-lg @error('year') invalid @enderror" name="year" value="{{ $data['learning_find']->year }}" required autocomplete="year" autofocus placeholder="โปรดระบุข้อมูล...">
                      @error('year')
                      <ul class="parsley-errors-list filled">
                        <li class="parsley-required">{{ $message }}</li>
                      </ul>
                    ...
                    <div class="col-md-12 form-group">
                      <label class="ml-1" for="published"> หน่วยงานที่จัดทำ <span class="text-danger">*</span></label>
                      <input id="published" type="text" class="form-control form-control-lg @error('published') invalid @enderror" name="published" value="{{ $data['learning_find']->published }}" required autocomplete="published" autofocus placeholder="โปรดระบุข้อมูล...">
                      @error('published')
                      <ul class="parsley-errors-list filled">
                        <li class="parsley-required">{{ $message }}</li>
                      </ul>
                    ...
                    <div class="col-md-12 form-group">
                      <label class="ml-1" for="intro"> Link Youtube </label>
                      <input id="intro" type="text" class="form-control form-control-lg @error('intro') invalid @enderror" name="intro" value="{{ $data['learning_find']->intro }}" autocomplete="intro" autofocus placeholder="โปรดระบุข้อมูล...">
                      @error('intro')
                      <ul class="parsley-errors-list filled">
                        <li class="parsley-required">{{ $message }}</li>
                      </ul>
                    ...
                    <div class="col-md-12 form-group">
                      ...
                      <input id="meta_title" type="text" class="form-control form-control-lg @error('meta_title') invalid @enderror" name="meta_title" value="{{ $data['learning_find']->meta_title }}" autocomplete="meta_title" autofocus placeholder="โปรดระบุข้อมูล...">
                      @error('meta_title')
                      <ul class="parsley-errors-list filled">
                        <li class="parsley-required">{{ $message }}</li>
                      </ul>
                    ...
                    <div class="col-md-12 form-group">
                      ...
                      <input id="meta_description" type="text" class="form-control form-control-lg @error('meta_description') invalid @enderror" name="meta_description" value="{{ $data['learning_find']->meta_description }}" autocomplete="meta_description" autofocus placeholder="โปรดระบุข้อมูล...">
                    ...
                    <div class="col-md-12 form-group">
                      ...
                      <input id="meta_keyword" type="text" class="form-control form-control-lg @error('meta_keyword') invalid @enderror" name="meta_keyword" value="{{ $data['learning_find']->meta_keyword }}" autocomplete="meta_keyword" autofocus placeholder="โปรดระบุข้อมูล...">
                      @error('meta_keyword')
                      <ul class="parsley-errors-list filled">
                        <li class="parsley-required">{{ $message }}</li>
                      </ul>
                ...
                <div class="col-md-4">
                  <div class="col-md-12 form-group">
                    <div class="mb-1">
                      ...
                      <div class="img-file-upload-2">
                        <img src="{{ asset('images/learning').'/'.$data['learning_find']->image_desktop }}" class="rounded w-100">
                      </div>
                      ...
                      <input type="hidden" id="file_upload_dektop_hdf" name="file_upload_dektop_hdf" value="{{ $data['learning_find']->image_desktop }}">
                  ...
                  <div class="col-md-12 form-group">
                    ...
                    <input type="hidden" id="file_upload_pdf_hdf" name="file_upload_pdf_hdf" value="{{ $data['learning_find']->file_pdf }}">
                    @if(!empty($data['learning_find']->file_pdf))
                    <a href="javascript: void(0);" data-file="{{ $data['learning_find']->file_pdf }}" class="h2 m-0 text-danger" id="close-pdf"><i class="fe-trash-2"></i></a>
                    @endif

                    <span class="mt-1 ml-1" style="font-size: 10px;"> {{ $data['learning_find']->file_pdf }} </span>
                ...
                <div class="col-md-12">
                  ...
                  <textarea cols="10" id="file_text" name="file_text" rows="10"><?php echo @file_get_contents(storage_path() . '/app/' . $data['learning_find']->file_text); ?></textarea>
              ...
              <div class="row">
                ...
                <div class="col-md-6 form-group text-right">
                  <a href="{{ route('learning.dropzone', $data['learning_find']->id) }}" class="btn btn-lg btn-secondary waves-effect waves-light">
                    <i class="fe-image"></i>
