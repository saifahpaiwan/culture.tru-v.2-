              ...
              <div class="row">
                <div class="col-md-8">
                  <div class="row">
                    ...
                    <div class="col-md-12 form-group">
                      <label class="ml-1" for="slug"> Link Youtube </label>
                      <input id="slug" type="text" class="form-control form-control-lg @error('slug') invalid @enderror" name="slug" value="{{ old('slug') }}" autocomplete="slug" autofocus placeholder="โปรดระบุข้อมูล...">
                      @error('slug')
                      <ul class="parsley-errors-list filled">
                        <li class="parsley-required">{{ $message }}</li>
                      </ul>
