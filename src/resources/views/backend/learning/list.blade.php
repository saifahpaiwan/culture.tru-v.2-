        ...
        <div class="card">
          <div class="card-header" style="background: #ddd;">
            <div class="row">
              ...
              <div class="col-md-2">
                <input class="form-control mb-1" type="number" min="1900" max="{{ date('Y') }}" step="1" id="date" name="date" placeholder="ค้นหาปีที่แต่ง..." />
              </div>
              <div class="col-md-2">
              ...
              <div class="col-md-3 text-right">
                ...
                <a href="{{ route('learning.add') }}" class="btn btn-primary waves-effect waves-light"><i class="fe-plus-square"></i> เพิ่ม </a>
              </div>
            </div>
          </div>
          <div class="card-body">
            <div class="h5"> ตารางข้อมูลประจำวันที่ {{ date('m/d/Y') }}
