              ...
              <div class="card-header" style="background: #ddd;">  
                <div class="row">  
                  ...
                  <div class="col-md-3 text-right"> 
                    ...
                    <a href="{{ route('slideshow.add') }}" class="btn btn-primary waves-effect waves-light"><i class="fe-plus-square"></i> เพิ่ม </a> 
                  </div>
                </div>
              </div>
              <div class="card-body">  
...
$(document).on('click', '#search', function(event) { 
  ...
  function datatable(keywrod, status){  
    var table = $('#tbl-data').DataTable({
      ...
      columns: [   
        {data: 'slideshow_img', name: 'slideshow_img'},  
        {data: 'title', name: 'title'},
        {data: 'slideshow_status', name: 'slideshow_status'}, 
