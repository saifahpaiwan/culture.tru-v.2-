          ...
          <div class="card-body">
            ...
            <form method="POST" action="{{ route('save.page') }}" id="form" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input id="page_title" type="text" class="form-control form-control-lg @error('page_title') invalid @enderror" name="page_title" value="{{ old('page_title') }}" required autocomplete="page_title" autofocus placeholder="โปรดระบุข้อมูล...">
                      @error('page_title')
                    ...
                    <div class="col-md-12 form-group">
                      ...
                      <textarea class="form-control form-control-lg @error('page_intro') invalid @enderror" rows="2" id="page_intro" name="page_intro" autocomplete="page_intro" autofocus placeholder="โปรดระบุข้อมูล...">{{ old('page_intro') }}</textarea>
                      @error('page_intro')
                      <ul class="parsley-errors-list filled">
                        <li class="parsley-required">{{ $message }}</li>
                      </ul>
                    ...
                    <div class="col-md-12 form-group">
                      ...
                      <input id="page_meta_title" type="text" class="form-control form-control-lg @error('page_meta_title') invalid @enderror" name="page_meta_title" value="{{ old('page_meta_title') }}" autocomplete="page_meta_title" autofocus placeholder="โปรดระบุข้อมูล...">
                    ...
                    <div class="col-md-12 form-group">
                      ...
                      <input id="page_meta_description" type="text" class="form-control form-control-lg @error('page_meta_description') invalid @enderror" name="page_meta_description" value="{{ old('page_meta_description') }}" autocomplete="page_meta_description" autofocus placeholder="โปรดระบุข้อมูล...">
                    ...
                    <div class="col-md-12 form-group">
                      ...
                      <input id="page_meta_keyword" type="text" class="form-control form-control-lg @error('page_meta_keyword') invalid @enderror" name="page_meta_keyword" value="{{ old('page_meta_keyword') }}" autocomplete="page_meta_keyword" autofocus placeholder="โปรดระบุข้อมูล...">
                    ...
                    <div class="col-md-6">
                      <div class="d-flex mt-3">
                        ...
                        <div class="ml-2">
                          <div> อัพโหลดไฟล์ PDF ถ้ามี Size 20MB.</div>
                ...
                <div class="col-md-12">
                  <hr>
                  <textarea cols="10" id="page_file_text" name="page_file_text" rows="10"><?php echo old('page_file_text'); ?></textarea>
