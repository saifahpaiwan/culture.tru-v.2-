...
class CreateResearchsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('researchs', function (Blueprint $table) {
            ...
            $table->string('author')->comment('ชื่อผู้แต่ง')->nullable();
            $table->integer('type')->comment('ประเภท')->nullable();
            $table->string('keyword')->comment('คำสำคัญ')->nullable();
            $table->string('year')->comment('ปี')->nullable();
            $table->string('published')->comment('หน่วยงานที่จัดพิมพ์')->nullable();
